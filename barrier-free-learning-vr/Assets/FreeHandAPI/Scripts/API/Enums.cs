...
{
    ///<summary>In the Platforms enum, all hardware platforms that are supported by the Free Hand API 
    ///are listed. In order to use the FreeHandRuntime, you have to initialize it to a specific
    ///platform using the FreeHandRuntime.SetPlatform method. If you want to use a custom platform
    ...
    {
        ///<value>Perform a stage transition when FreeHandRuntime.GiveCue() method is called.</value> 
        Cue = 0,
