...
namespace FreeHandGestureFramework
{
    ...
    public class GestureStage
    {
        ...
        ///(which might for example happen during FreeHandRuntime.Update()). It will be set to
        ...
        ///NOTE: You may consider adding event listeners to the FreeHandRuntime instance instead of different
