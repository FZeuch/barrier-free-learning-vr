...
namespace FreeHandGestureFramework.DataTypes
{
    ...
    {
        ///<value>This delegate must be used for callback routines in the context of Free Hand Gesture Runtime Events (see GestureEventTypes)</value>
    ...
    public class FreeHandEventArgs : EventArgs
    {
        ...
        ///<value>The index of the gesture that caused the invocation of the event. 
        ///The index refers to the list of gestures GestureHandler.Gestures.</value>
